...
set caze=QBO_oldvremap_nlev${nlev}_${src}_${cset}_${res}_${pecount} #_NTHRDS${NTHRDS}_${steps}${stopoption}
...
echo "se_vert_remap_uvtq_alg         = 'PPM_bc_linear_extrapolation'" >> user_nl_cam
