...
set caze=pk02_fv-high-order-top_aamfix_${cset}_${src}_${res}_nlev${nlev}_${pecount}_NTHRDS${NTHRDS}_${steps}${stopoption}
...
if ($res == "f09_f09_mg17") then
  ...
  echo "fv_am_geom_crrct = .true." >> user_nl_cam
  echo "fv_am_correction        =  .true." >> user_nl_cam
  echo "fv_am_fix_lbl          =  .true." >> user_nl_cam
  echo "fv_am_fixer            =  .true." >> user_nl_cam
endif
