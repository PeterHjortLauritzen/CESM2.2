...
\end{itemize}
\subsection{Code stuff}
\begin{itemize}
\item \verb+utils/physconst.F90+: unify new code for {\em{kmvis}} and {\em{kmcnd}} for WACCM-x. Similarly for heat capacity and R.
\item 
\end{itemize}
\section{Results}
\subsection{CAM}
...
\end{itemize}
\subsection{\veb+physconst.F90+}
\begin{itemize}
\item species dependent code
\end{itemize}
\subsection{clean-up}
\begin{itemize}
\item remove namelist options that are not tested: variable_nsplit, ...
\end{itemize}
